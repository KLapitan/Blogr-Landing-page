...
{/* container of textheader */}
    <div className="gap-4 flex flex-col border lg:mt-20 ">
    
 
    <div className="flex flex-col items-center justify-center  text-NWhite w-full p-2 gap-2 z-20">
    <h2 className="font-Overpass font-normal text-4xl text-center tracking-tight p-2 w-80 border md:text-5xl md:w-full lg:text-7xl lg:w-full lg:tracking-tighter">A modern publishing platform</h2>
    ...
    <button className="border rounded-full bg-NWhite text-BGN-Red-550 px-4 py-2 lg:px-5 lg:py-3 lg:text-lg lg:font-bold">Start for Free</button>
    <button className="border rounded-full px-4 py-2 border-NWhite text-NWhite lg:px-6 lg:py-3 lg:text-lg">Learn More</button>
    </div>
    </div>
  		...
  		{/* DEsign for future section , extensible editor , robustmanagement */}
  			<section className="h-auto lg:h-200 p-2 border-3">
    			<div className="flex flex-col items-center  lg:flex-row-reverse lg:relative  ">
						...
						{/* images right */}
						<div className="lg:relative  lg:w-738 lg:h-screen lg:overflow-x-clip  lg:flex border	">
						<picture>
            			...
            			<div className=" w-full  flex flex-col items-center p-2 gap-2 lg:h-64 lg:gap-0 lg:items-start  ">
                    		...
                    		<span className="text-3xl p-3  tracking-tight font-Overpass text-center  w-64 text-PBlue-900 font-bold lg:text-left lg:w-auto lg:text-xl lg:p-0">Introducing an extensible editor</span>
                    			...
                    			<p className="text-wrap text-center text-lg  font-Overpass p-2 mb-8 lg:text-left lg:tracking-wide lg:text-md lg:-ml-2 lg:w-155 border mt-4 lg:text-NGray-600 ">Blogr features an exceedingly intuitive interface which lets you focus on one thing: creating content. 
		...
		<section className="h-auto border-5 p-2 lg:p-0">
		
                      {/* state of the art container */}
                    	<div className=" relative  mt-2 border-4 p-2 lg:p-0 w-full h-auto">  

                                {/* phone */}
							<picture><img src="images/illustration-phones.svg" alt="phone-picture" className="absolute left-4 w-80 h-80  z-20 lg:hidden" /></picture> 
                        
							<picture><img src="images/illustration-phones.svg" alt="phone-picture" className="hidden absolute lg:block lg:left-26 lg:w-155 lg:h-170  lg:z-20 lg:-top-16  " /></picture> 
                        
								{/*container for pictures and description  */}
                        	<div className="relative w-full h-132.5 mt-35   rounded-tr-[100px]  rounded-bl-[100px] bg-BGB-Purple-950 flex flex-col  overflow-hidden lg:rounded-tr-[90px] lg:rounded-bl-[90px] lg:mt-5 lg:h-120">
                            	...
                            	{/* description */}
								<div className=" w-auto p-0  flex flex-col gap-3 z-30 mt-45 border lg:w-xl lg:absolute lg:left-190">
						...
						{/* free,open, simple */}
						<div className="w-auto mt-7 border flex flex-col gap-4 lg:flex-row lg:min-h-screen lg:mb-26">
						<picture>
								<img src="images/illustration-laptop-mobile.svg" alt="laptop-mobile" className="lg:hidden" />
						</picture>
						<picture>
...
<div className="lg:flex lg:flex-col lg:border lg:border-green-500 lg:w-auto lg:items-center lg:justify-center lg:gap-0 lg:-ml-20 lg:mt-20">
						<div className="flex flex-col gap-5 p-3 lg:w-xl border">
							...
							<p className="text-lg text-center text-NGray-600 tracking-normal w-auto lg:text-left lg:w-auto lg:tracking-normal">Blogr is a free and open source application backed by a large community of helpful developers. It supports 
  							...
  							and works seamlessly with Google Analytics. The architecture is clean and is relatively easy to learn.</p>
								...
								{/* power tooling */}
							<div className="border w-full h-auto p-2 flex flex-col gap-3 mb-10 lg:w-xl">
